...
Data CME To Accured
                ...
                Dear Mr / Mrs. {{$namabusdev}}
                <br>
                <br>
                <br>
                Berikut ini kami lampiran data Accured pada email ini.
                <br>
                <br>
                <br>
CME Dokumen ID : <strong style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">{{$nodoc}}</strong><br>
SUBMIT BY : <strong style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">{{$name}}</strong><br>
<br>
Jika anda mengalamai kendala bisa mendownload dari link berikut ini :
<a href="{{asset($file)}}" target="_blank"><button class="btn btn-warning">Download</button></a>
