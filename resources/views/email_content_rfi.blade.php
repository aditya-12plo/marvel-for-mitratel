...
URL PID DETAIL : <a href="{{$url}}" target="_blank"><button type="button"><strong style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">Click Me!</strong></button></a><br>
