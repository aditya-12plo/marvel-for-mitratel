...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Form Penambahan Dokumen Site Opening Project ID {{this.rowDatanya.project.projectid}}</div>
        </div>
    </div>
...
return hashids.decode(id); 
  ...
  timer: 1500
            ...
            backLink() {
			   this.$router.push('/site-opening-add');
            } ,
    allcap (e, o, prop) {
