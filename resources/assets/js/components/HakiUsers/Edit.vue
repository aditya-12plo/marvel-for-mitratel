...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Form Perubahan Data Akses User Akses</div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
export default {
 ...
 watch: {
        ...
        methods: {
               dataAction () {
      if(this.typenya === "edit-user-haki")
      {
           this.forms.setFillItem(this.rowDatanya.user);
      }
      else
      {
  ...
  if (result.value) {
                axios.put('/karyawan/edituserhaki/'+ this.forms.id, this.forms)
                    .then(response => {
                      this.forms.password=''; 
