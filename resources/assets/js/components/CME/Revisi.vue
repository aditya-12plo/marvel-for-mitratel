...
Vue.component('view-get-pid', require('./GetSubmitProject.vue'))
...
this.isLoading = false;   
 ...
 axios.post('/karyawan/UpdateCMEAccrualRevisi', masuk)
                    .then(response => { 
return true;
                    })
 },
 backLink() {
 this.$router.push('/cme-revisi');
            } ,
 success(kata) {
      this.$swal({
  position: 'top-end',
...
dataAction () {
      if(this.typenya === "revisi-submit-cme-data")
      {
