...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Form Approval DROP Project ID {{this.rowDatanya.project.projectid}}</div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
{{this.rowDatanya.project.site_name_spk}}
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        <label for="address_spk">ADDRESS SPK</label>
                                        <br>
{{this.rowDatanya.project.address_spk}}
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        <label for="address_spk">COORDINATE SPK</label>
                                        <br>
...
export default {
 ...
 watch: {
        ...
        methods: {
               dataAction () {
      if(this.typenya === "approval-drop-hq")
      {
           this.resetforms();
...
this.status = '';
this.kata = '';                    
this.statusmessage = 'APPROVED DROP SITE';
this.status = 105;
this.kata = 'DROP SITE Project ID '+this.rowDatanya.project.projectid+' Di Setujui';
this.errorNya = '';
this.message = '';
...
this.status = '';
this.kata = '';                    
this.statusmessage = 'DROP SITE DI TOLAK';
this.status = 1;
this.kata = 'DROP SITE Project ID '+this.rowDatanya.project.projectid+' DI TOLAK';
this.errorNya = '';
this.message = '';
this.modal.set('approve', true); 
  ...
  timer: 1500
            ...
            backLink() {
			  this.$router.push('/approval-drop-project-hq');
            } ,
    allcap (e, o, prop) {
