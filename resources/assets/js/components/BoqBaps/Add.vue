...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Form Penambahan Dokumen BOQ BAPS Project ID {{this.rowDatanya.project.projectid}}</div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
window.open(routeData.href, '_blank');
               ...
               dataAction () {
      if(this.typenya === "add-document-boq-baps")
      {
           this.resetforms();
  ...
  timer: 1500
            ...
            backLink() {
 this.$router.push('/documents-boq-baps');
            } ,
    allcap (e, o, prop) {
...
'Ooppss?',
 kata,
  ...
  if (result.value) {    
   ...
   masuk.set('kata', 'SUBMIT BOQ BAPS')
   ...
   masuk.set('statusmessage', 'SUBMIT DOKUMEN BOQ BAPS')
   masuk.set('document', 'DOKUMEN BOQ BAPS')
   masuk.set('status', 52)
                axios.post('/karyawan/AddDocumentBoqBaps', masuk)
                    .then(response => { 
                 ...
                 this.backLink();
                      ...
                      else
                      {
                         this.modal.set('approve', false);
                          this.isLoading = false; 
                        this.errorNya = {document_boq_baps:[response.data.error]};
                      }
                    })
                    .catch(error => {
