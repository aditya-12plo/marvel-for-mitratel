...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Form Mapping Site Project ID {{this.rowDatanya.project.projectid}}</div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
{{this.rowDatanya.project.regional}}
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <br>
<input type="text" @input="allcap($event, forms, 'site_id_spk')" class="form-control" placeholder="NO BAN / BAK" v-model="forms.site_id_spk" required>
<div class="help-block"><ul role="alert"><li v-for="error of errorNya['site_id_spk']"><span style="color:red;">{{ error }}</span></li></ul></div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <br>
<input type="text" @input="allcap($event, forms, 'site_name_spk')" class="form-control" placeholder="NO BAN / BAK" v-model="forms.site_name_spk" required>
...
export default {
 ...
 watch: {
        ...
        methods: {
               dataAction () {
      if(this.typenya === "add-mapping-site")
      {
           this.forms= this.rowDatanya.project;
           this.wo_date.time= this.rowDatanya.project.wo_date;
  ...
  timer: 1500
            ...
            backLink() {
 this.$router.push('/input-mapping-site');
            } ,
    allcap (e, o, prop) {
...
'Ooppss?',
 kata,
  ...
  if (result.value) {
    this.isLoading = true;   
                axios.post('/karyawan/SubmitMappingSite', this.forms)
                    .then(response => {
