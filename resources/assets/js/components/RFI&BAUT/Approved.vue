...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Form Approval Dokumen DRM Project ID {{this.rowDatanya.project.projectid}}</div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
window.open(routeData.href, '_blank');
               ...
               dataAction () {
      if(this.typenya === "approval-document-cme-manager")
      {
           this.resetforms();
...
this.status = '';
this.kata = '';                    
this.statusmessage = 'APPROVED DOKUMEN RFI & BAUT';
this.status = 40;
this.kata = 'Dokumen RFI & BAUT Project ID '+this.rowDatanya.project.projectid+' Di Setujui';
this.errorNya = '';
this.message = '';
...
this.status = '';
this.kata = '';
this.statusmessage = 'REVISI DOKUMEN RFI & BAUT';
this.status = 38;
this.kata = 'Harap Perbaiki Dokumen RFI & BAUT Project ID '+this.rowDatanya.project.projectid;
this.errorNya = '';
this.message = '';
this.modal.set('approve', true); 
  ...
  timer: 1500
            ...
            backLink() {
			  this.$router.push('/rfi-baut-approval');
            } ,
    allcap (e, o, prop) {
