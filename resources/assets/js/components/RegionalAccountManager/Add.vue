...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Form Penambahan Data Akses User Akses REGIONAL {{this.rowDatanya.regional}}</div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
var masuk ={
 ...
 posisi:'AM SUPPORT',
 regional:this.rowDatanya.regional,
area:this.rowDatanya.area}; 
