...
<!-- @view -->
 ...
 <!-- @delete -->
        ...
        <template slot="header" ><h4>Delete Log</h4></template>
        <template slot="body" >
...
<div style="overflow-x:auto;">
  <table>
    ...
    <tr>
      ...
      <td colspan="3"><input type="text" v-model="filterText" class="form-control" @keyup.enter="doFilter" placeholder="Email/Table Name/Action"></td>
    </tr>
     <tr>
  ...
  methods: {
   ...
   var check = confirm("Are you sure you want to delete this row?");  
                ...
                //console.log(join_selected_values);
                    ...
                    axios.delete('/kevler/kevlerLogDeleteAll/'+ join_selected_values)
                    .then(response => {
                this.errorNya = '';
   ...
   resetOptions() {
    ...
    onCellClicked (data, field, event) {
      ...
      this.$refs.vuetable.toggleDetailRow(data.id)
            ...
            destroyItem(kode){
                axios.delete('/kevler/kevlerLog/'+ kode)
                    .then(response => {
                this.errorNya = '';
                this.resetFilter();
...
onLoading() {
    ...
    onLoadingError() {
                this.loading = true;
                axios.get('/kevler/kevlerLog').then((response) => {
                    this.dataNya = response.data;
                    this.loading = false
                }).catch(error => {
				if (! _.isEmpty(error.response)) {
