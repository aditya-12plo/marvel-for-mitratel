...
window.open(routeData.href, '_blank');
               ...
               dataAction () {
      if(this.typenya === "approval-document-drm")
      {
           this.resetforms();
...
this.status = '';
this.kata = '';                    
this.statusmessage = 'APPROVED DOKUMEN DRM';
this.status = 7;
this.kata = 'Dokumen DRM Project ID '+this.rowDatanya.project.projectid+' Di Setujui';
this.errorNya = '';
this.message = '';
...
this.status = '';
this.kata = '';
this.statusmessage = 'REVISI DOKUMEN DRM';
this.status = 6;
this.kata = 'Harap Perbaiki Dokumen DRM Project ID '+this.rowDatanya.project.projectid;
this.errorNya = '';
this.message = '';
this.modal.set('approve', true); 
  ...
  timer: 1500
            ...
            backLink() {
			  this.$router.push('/approval-documents-drm');
            } ,
    allcap (e, o, prop) {
