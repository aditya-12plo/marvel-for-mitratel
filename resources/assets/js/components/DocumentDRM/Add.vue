...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Form Penambahan Dokumen DRM Project ID {{this.rowDatanya.project.projectid}}</div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
window.open(routeData.href, '_blank');
               ...
               dataAction () {
      if(this.typenya === "add-document-drm")
      {
           this.resetforms();
  ...
  timer: 1500
            ...
            backLink() {
         this.$router.push('/documents-drm');
            } ,
    allcap (e, o, prop) {
        ...
        else
{
   ...
   masuk.set('status', 5)
                axios.post('/karyawan/AddDocumentDRM', masuk)
                    .then(response => { 
