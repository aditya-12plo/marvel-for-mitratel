...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <h1 align="center">Form Perubahan Dokumen DRM Project ID {{this.rowDatanya.project.projectid}}</h1>
        </div>
    </div>
...
<button type="button" @click="drop()" class="btn btn-raised btn-success" v-if="this.komunikasi.length > 0">
...
export default {
 ...
 data () {
  ...
  modal:new CrudModal({komunikasiproject: false,approve: false , drop: false}),
    ...
    position: 'up right',
    closeBtn: true,
  forms: new CrudForm({id:'' , project_id:'' , documentdrmid:'' , site_id_actual:'' , province:'' , city:'' , address_actual:'' , longitude_actual:'' , latitude_actual:'' , kom_date:'' , drm_date:'' , document_kom:'' , document_drm:'' , created_at:''}), 
    errors: new Errors() ,
    errorNya: [],
    komunikasi:[] ,
    dataNya: {name : '', level:''}, 
...
'Ooppss?',
 kata,
  'question'
            ...
            backLink() {
			  this.$router.push('/repair-documents-drm');
            } ,
    allcap (e, o, prop) {
        ...
        else
{
   ...
   masuk.set('site_id_actual', this.forms.site_id_actual)
   masuk.set('site_name_actual', this.forms.site_name_actual)
   masuk.set('city', this.forms.city)
