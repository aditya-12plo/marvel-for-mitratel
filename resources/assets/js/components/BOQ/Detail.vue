...
<section id="timeline" class="timeline-center timeline-wrapper">
  <div class="row">
    <div class="col-sm-12">
      <div class="content-header"><button type="button" class="btn btn-raised btn-warning" @click="backLink()"> <i class="ft-arrow-left position-left"></i> Kembali</button></div>
    </div>
  </div>
    ...
    <li class="timeline-item mt-5">
     ...
     <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <br>
{{this.rowDatanya.project.site_type}}
                    </fieldset>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <br>
{{this.rowDatanya.project.tower_type}}
                    </fieldset>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <br>
{{this.rowDatanya.project.roof_top_high}}
                    </fieldset>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <br>
{{this.rowDatanya.project.tower_high}}
                    </fieldset>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <br>
{{this.rowDatanya.project.rf_in_meters}}
                    </fieldset>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <br>
{{this.formatTower(this.rowDatanya.project.mw_in_meters)}}
                    </fieldset>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <br>
{{this.formatNumberRupiah(this.rowDatanya.project.harga_bulan)}}
                    </fieldset>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <br>
{{this.formatNumberRupiah(this.rowDatanya.project.harga_tahun)}}
                    </fieldset>
                                </div>
                   </div>
          </div>               
