...
var masuk = 
{
	...
	'project_id_verifikasi' : this.rowDatanya.project.project_id_verifikasi,
	'project_id_proses_pr' : join_selected_values,
}
axios.post('/karyawan/SubmitBOQApprovalProsesPR', masuk)
                    .then(response => { 
