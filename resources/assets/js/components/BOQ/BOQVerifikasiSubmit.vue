...
<button class="btn btn-default" @click="sumSelectedItems()">Ubah Status BOQ Menjadi Verifikasi <i class="ft-check-circle position-right"></i></button>
                                    </div>
</td>
       </tr>
</table>
...
dataAction () {
      if(this.typenya === "approved-boq-verifikasi-submit")
      { 
           return true;
      }
      else
 ...
 backLink() {
 this.$router.push('/boq-verifikasi');
            } ,
 success(kata) {
      this.$swal({
  position: 'top-end',
