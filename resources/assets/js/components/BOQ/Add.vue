...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Add BOQ Project ID {{this.rowDatanya.project.projectid}}</div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
export default {
 ...
 watch: {
        ...
        methods: {
               dataAction () {
      if(this.typenya === "add-document-boq")
      {
           this.resetforms();
