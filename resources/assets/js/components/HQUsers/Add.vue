...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Form Penambahan Data Akses User Akses AREA {{this.rowDatanya.area}} / AREA {{this.rowDatanya.area2}}</div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
export default {
 ...
 data () {
    ...
    formErrors:{},
	GetLevel:'', 
	forms: new CrudForm({id:'' , name:'' , email:'' , level:'',  posisi:'', areahq:'' , area:'',  area2:'',  regional:'',  password:'' , created_at:''}), 
	pilihan: ['REGIONAL','HQ'],
 ...
 watch: {
  ...
  timer: 1500
            ...
            backLink() {
			  this.$router.push('/user-access-for-hq');
            } ,
    allcap (e, o, prop) {
...
var masuk ={
 ...
 level:this.rowDatanya.level,
 posisi:'ACCOUNT MANAGER',
 regional:'',
areahq:this.forms.areahq}; 
                axios.post('/karyawan/listuser', masuk)
                    .then(response => {
                this.resetforms();
