...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Form Approval Dokumen BAKS BAUK Project ID {{this.rowDatanya.project.projectid}}</div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
		                        ...
		                        <div class="row">	 
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                                        <fieldset class="form-group">
                                            <label for="documentsis"><h4>Dokumen BAKS BAUK</h4></label> 
...
<div class="col-xl-4 col-lg-6 col-md-12 mb-1">
 ...
 <br>
{{this.rowDatanya.project.no_baks}}
                                    </fieldset>
                                </div> 
...
<div class="col-xl-4 col-lg-6 col-md-12 mb-1">
 ...
 <br>
{{this.rowDatanya.project.date_baks}}
                                    </fieldset>
                                </div> 
...
<a v-bind:href="'/files/'+this.rowDatanya.project.projectid+'/'+this.rowDatanya.project.document_baks" target="_blank"><button type="button" class="btn btn-success"><i class="ft-download"></i> Download</button></a>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <br> 
<a v-bind:href="'/files/'+this.rowDatanya.project.projectid+'/'+this.rowDatanya.project.document_wctr" target="_blank"><button type="button" class="btn btn-success"><i class="ft-download"></i> Download</button></a>                                        
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <br> 
<a v-bind:href="'/files/'+this.rowDatanya.project.projectid+'/'+this.rowDatanya.project.document_boq_project" target="_blank"><button type="button" class="btn btn-success"><i class="ft-download"></i> Download</button></a>                                        
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <br> 
<a v-bind:href="'/files/'+this.rowDatanya.project.projectid+'/'+this.rowDatanya.project.document_rfi_certificate" target="_blank"><button type="button" class="btn btn-success"><i class="ft-download"></i> Download</button></a>                                        
                                    </fieldset>
                                </div>
...
window.open(routeData.href, '_blank');
               ...
               dataAction () {
      if(this.typenya === "approval-document-baks-bauk-manager")
      {
           this.resetforms();
...
this.status = '';
this.kata = '';                    
this.statusmessage = 'APPROVED DOKUMEN BAKS BAUK';
this.status = 51;
this.kata = 'Dokumen BAKS BAUK Project ID '+this.rowDatanya.project.projectid+' Di Setujui';
this.errorNya = '';
this.message = '';
...
this.status = '';
this.kata = '';
this.statusmessage = 'REVISI DOKUMEN BAKS BAUK';
this.status = 50;
this.kata = 'Harap Perbaiki Dokumen BAKS BAUK Project ID '+this.rowDatanya.project.projectid;
this.errorNya = '';
this.message = '';
this.modal.set('approve', true); 
  ...
  timer: 1500
            ...
            backLink() {
			  this.$router.push('/documents-baks-bauk-approval');
            } ,
    allcap (e, o, prop) {
