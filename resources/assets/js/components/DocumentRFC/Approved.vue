...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Form Approval Dokumen RFC Project ID {{this.rowDatanya.project.projectid}}</div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
PO Release + <b>{{this.rowDatanya.project.target_rfi}}</b> Days                                  
         ...
         <label for="power_capacity">POWER CAPACITY</label>
                                        <br>
<b>{{this.rowDatanya.project.power_capacity}}</b> KVA                                        
...
this.modal.set('approve', true); 
  ...
  timer: 1500
            ...
            backLink() {
			  this.$router.push('/approval-documents-rfc');
            } ,
    allcap (e, o, prop) {
