...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Form Penambahan Dokumen BAPS Project ID {{this.rowDatanya.project.projectid}}</div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
window.open(routeData.href, '_blank');
               ...
               dataAction () {
      if(this.typenya === "add-document-baps")
      {
           this.resetforms();
  ...
  timer: 1500
            ...
            backLink() {
 this.$router.push('/documents-baps');
            } ,
    allcap (e, o, prop) {
...
'Ooppss?',
 kata,
  ...
  if (result.value) {    
   ...
   masuk.set('statusmessage', 'SUBMIT DOKUMEN BAPS')
   masuk.set('document', 'DOKUMEN BAPS')
   masuk.set('status', 53)
                axios.post('/karyawan/AddDocumentBaps', masuk)
                    .then(response => { 
