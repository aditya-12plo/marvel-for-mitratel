...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Rfi Detail Project ID {{this.rowDatanya.project.projectid}}</div>
        </div>
    </div>
...
return hashids.decode(id); 
  ...
  timer: 1500
            ...
            backLink() {
			   this.$router.push('/approval-documents-rfi-haki');
            } ,
                              RepairItem(){
this.statusmessage = '';
this.status = '';
this.statusboq = '';
this.kata = '';
this.statusmessage = 'REVISI DOKUMEN RFI Detail';
this.status = 43;
this.statuscme = 0;
this.kata = 'Harap Perbaiki Dokumen RFI Project ID '+this.rowDatanya.project.projectid;
this.errorNya = '';
this.message = '';
...
this.statusboq = '';
this.kata = '';                    
this.statusmessage = 'APPROVED DOKUMEN RFI Detail';
this.status = 42;
this.statuscme = 44;
this.kata = 'Dokumen RFI Project ID '+this.rowDatanya.project.projectid+' Di Setujui';
this.errorNya = '';
this.message = '';
this.modal.set('approve', true); 
...
'Ooppss?',
 kata,
  ...
  if (result.value) {
   ...
   masuk.set('document', 'APPROVAL RFI DETAIL')
   masuk.set('status', this.status)
   masuk.set('statuscme', this.statuscme)
                axios.post('/karyawan/ApprovalRfiDetail', masuk)
                    .then(response => { 
