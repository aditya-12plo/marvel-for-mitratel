...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <h1 align="center">Form Penambahan Dokumen Rfi Detail Project ID {{this.rowDatanya.project.projectid}}</h1>
        </div>
    </div>
 ...
 watch: {
      ...
      if(this.typenya === "RfiDetail-add-data")
      {
          ...
          //  var dateBerakhirnya = moment(datenya).add(jmlhari, 'days').format('YYYY-MM-DD');
           var dateBerakhir = moment(datenya).add( 10 , 'years').format('YYYY-MM-DD');
           var dateBerakhirnya = moment(dateBerakhir).add( -1 , 'days').format('YYYY-MM-DD');

          this.forms.rfi_detail_start_date = datenya;
          this.forms.rfi_detail_end_date = dateBerakhirnya;
