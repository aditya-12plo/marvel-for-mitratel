...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Form Perubahan Dokumen Excavation Project ID {{this.rowDatanya.project.projectid}}</div>
        </div>
    </div>
...
return hashids.decode(id); 
  ...
  timer: 1500
            ...
            backLink() {
			   this.$router.push('/excavation-revisi');
            } ,
    allcap (e, o, prop) {
...
'Ooppss?',
 kata,
  ...
  if (result.value) {
   ...
   masuk.set('status', 25)
                axios.post('/karyawan/RevisiDocumentExcavation', masuk)
                    .then(response => { 
