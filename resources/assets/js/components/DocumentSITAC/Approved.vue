...
<section class="basic-elements">
    <div class="row">
        <div class="col-sm-12">
            <div class="content-header" align="center">Form Approval Dokumen SITAC Project ID {{this.rowDatanya.project.projectid}}</div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
export default {
 ...
 watch: {
        ...
        methods: {
               dataAction () {
      if(this.typenya === "approval-document-sitac")
      {
           this.resetforms();
...
this.status = '';
this.kata = '';                    
this.statusmessage = 'APPROVED DOKUMEN SITAC';
this.status = 10;
this.kata = 'Dokumen SITAC Project ID '+this.rowDatanya.project.projectid+' Di Setujui';
this.errorNya = '';
this.message = '';
...
this.status = '';
this.kata = '';
this.statusmessage = 'REVISI DOKUMEN SITAC';
this.status = 9;
this.kata = 'Harap Perbaiki Dokumen SITAC Project ID '+this.rowDatanya.project.projectid;
this.errorNya = '';
this.message = '';
this.modal.set('approve', true); 
  ...
  timer: 1500
            ...
            backLink() {
			  this.$router.push('/approval-documents-sitac');
            } ,
    allcap (e, o, prop) {
